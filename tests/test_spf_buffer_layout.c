...
int main(void)
{
	...
	assert(spf_buffer_hop_receiver_rate_validate(1, UINT64_C(10000000)) == 0);
	assert(spf_buffer_hop_receiver_rate_validate(1, UINT64_C(5000000)) == -EINVAL);
	assert(spf_buffer_hop_receiver_rate_validate(0, UINT64_C(10000000)) == -EINVAL);
	assert(spf_buffer_hop_receiver_rate_validate(2, UINT64_C(2500000)) == 0);
	assert(spf_buffer_hop_receiver_rate_validate(2, UINT64_C(5000000)) == 0);
